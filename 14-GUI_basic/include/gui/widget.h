...
namespace myos
{
    namespace gui
    {
        class Widget
        {
            ...
            public:
                Widget(Widget *parent, common::int32_t y, common::int32_t w, common::int32_t h, common::uint8_t r, common::uint8_t g, common::uint8_t b);
                ~Widget();
        ...
        class CompositeWidget : public Widget
        {
            ...
            public:
                CompositeWidget(Widget *parent, common::int32_t y, common::int32_t w, common::int32_t h, common::uint8_t r, common::uint8_t g, common::uint8_t b);
                ~CompositeWidget();
